export file {		// uicc/toolkit
	...
	constant_pool {
		...
		Constant_Classref_info {
			tag	7
			name_index	356		// uicc/toolkit/ToolkitConstants
		}
		Constant_Utf8_info {
			tag	1
			length	14
		...
		Constant_Classref_info {
			tag	7
			name_index	360		// uicc/toolkit/ToolkitInterface
		}
		Constant_Utf8_info {
			tag	1
			length	28
		...
		Constant_Classref_info {
			tag	7
			name_index	362		// javacard/framework/Shareable
		}
		Constant_Utf8_info {
			tag	1
			length	8
		...
		Constant_Classref_info {
			tag	7
			name_index	387		// uicc/toolkit/ToolkitRegistry
		}
		Constant_Utf8_info {
			tag	1
			length	6
		...
		Constant_Classref_info {
			tag	7
			name_index	390		// uicc/toolkit/BERTLVEditHandler
		}
		Constant_Utf8_info {
			tag	1
			length	20
		...
		Constant_Classref_info {
			tag	7
			name_index	559		// uicc/toolkit/TerminalProfile
		}
		Constant_Utf8_info {
			tag	1
			length	13
		...
		Constant_Classref_info {
			tag	7
			name_index	563		// uicc/toolkit/EnvelopeHandlerSystem
		}
		Constant_Utf8_info {
			tag	1
			length	16
		...
		Constant_Classref_info {
			tag	7
			name_index	588		// uicc/toolkit/ToolkitException
		}
		Constant_Utf8_info {
			tag	1
			length	19
		...
		Constant_Classref_info {
			tag	7
			name_index	590		// java/lang/Throwable
		}
		Constant_Utf8_info {
			tag	1
			length	19
		...
		Constant_Classref_info {
			tag	7
			name_index	592		// java/lang/Exception
		}
		Constant_Utf8_info {
			tag	1
			length	26
		...
		Constant_Classref_info {
			tag	7
			name_index	594		// java/lang/RuntimeException
		}
		Constant_Utf8_info {
			tag	1
			length	39
		...
		Constant_Classref_info {
			tag	7
			name_index	596		// javacard/framework/CardRuntimeException
		}
		Constant_Utf8_info {
			tag	1
			length	33
		...
		Constant_Classref_info {
			tag	7
			name_index	599		// uicc/toolkit/ProactiveHandlerSystem
		}
		Constant_Utf8_info {
			tag	1
			length	40
		...
		Constant_Classref_info {
			tag	7
			name_index	602		// uicc/toolkit/EnvelopeResponseHandlerSystem
		}
		Constant_Utf8_info {
			tag	1
			length	8
		...
		Constant_Classref_info {
			tag	7
			name_index	606		// uicc/toolkit/ToolkitRegistrySystem
		}
		Constant_Utf8_info {
			tag	1
			length	41
		...
		Constant_Classref_info {
			tag	7
			name_index	609		// uicc/toolkit/ProactiveResponseHandlerSystem
		}
		Constant_Utf8_info {
			tag	1
			length	12
	...
	export_classes {
		...
		class_info {		// uicc/toolkit/ToolkitConstants
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	276		// PRO_CMD_SEND_DTMF
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	277		// PRO_CMD_LAUNCH_BROWSER
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	278		// PRO_CMD_PLAY_TONE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	279		// PRO_CMD_DISPLAY_TEXT
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	280		// PRO_CMD_GET_INKEY
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	281		// PRO_CMD_GET_INPUT
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	282		// PRO_CMD_SELECT_ITEM
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	283		// PRO_CMD_PROVIDE_LOCAL_INFORMATION
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	284		// PRO_CMD_TIMER_MANAGEMENT
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	285		// PRO_CMD_SET_UP_IDLE_MODE_TEXT
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	286		// PRO_CMD_PERFORM_CARD_APDU
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	287		// PRO_CMD_POWER_ON_CARD
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	288		// PRO_CMD_POWER_OFF_CARD
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	289		// PRO_CMD_GET_READER_STATUS
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	290		// PRO_CMD_RUN_AT_COMMAND
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	291		// PRO_CMD_LANGUAGE_NOTIFICATION
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	292		// PRO_CMD_OPEN_CHANNEL
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	293		// PRO_CMD_CLOSE_CHANNEL
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	294		// PRO_CMD_RECEIVE_DATA
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	295		// PRO_CMD_SEND_DATA
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	296		// PRO_CMD_GET_CHANNEL_STATUS
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	297		// PRO_CMD_SERVICE_SEARCH
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	298		// PRO_CMD_GET_SERVICE_INFORMATION
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	299		// PRO_CMD_DECLARE_SERVICE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	302		// DEV_ID_EARPIECE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	303		// DEV_ID_ADDITIONAL_CARD_READER_0
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	304		// DEV_ID_ADDITIONAL_CARD_READER_1
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	305		// DEV_ID_ADDITIONAL_CARD_READER_2
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	306		// DEV_ID_ADDITIONAL_CARD_READER_3
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	307		// DEV_ID_ADDITIONAL_CARD_READER_4
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	308		// DEV_ID_ADDITIONAL_CARD_READER_5
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	309		// DEV_ID_ADDITIONAL_CARD_READER_6
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	310		// DEV_ID_ADDITIONAL_CARD_READER_7
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	311		// DEV_ID_CHANNEL_BASE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	312		// DEV_ID_CHANNEL_1
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	313		// DEV_ID_CHANNEL_2
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	314		// DEV_ID_CHANNEL_3
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	315		// DEV_ID_CHANNEL_4
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	316		// DEV_ID_CHANNEL_5
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	317		// DEV_ID_CHANNEL_6
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	318		// DEV_ID_CHANNEL_7
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	320		// DEV_ID_TERMINAL
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	321		// value = -126
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	323		// value = -125
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	324		// POLL_NO_DURATION
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	325		// POLL_SYSTEM_DURATION
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	327		// RES_CMD_PERF_PARTIAL_COMPR
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	328		// RES_CMD_PERF_MISSING_INFO
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	329		// RES_CMD_PERF_REFRESH_ADD_EF_READ
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	330		// RES_CMD_PERF_REQ_ICON_NOT_DISP
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	331		// RES_CMD_PERF_MODIF_CC_NAA
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	332		// RES_CMD_PERF_LIMITED_SERVICE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	333		// RES_CMD_PERF_WITH_MODIFICATION
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	334		// RES_REFRESH_PERF_NO_NAA_ACTIVE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	335		// RES_CMD_PERF_SESSION_TERM_USER
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	336		// RES_CMD_PERF_BACKWARD_MOVE_REQ
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	337		// RES_CMD_PERF_NO_RESP_FROM_USER
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	338		// RES_CMD_PERF_HELP_INFO_REQ
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	339		// RES_TEMP_PB_TERMINAL_UNABLE_PROC
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	340		// RES_TEMP_PB_SESSION_TERM_USER
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	341		// RES_TEMP_PB_USER_REJECT_CALL_REQ
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	342		// RES_TEMP_PB_USER_CLEAR_CALL
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	343		// RES_TEMP_PB_IN_CONTR_TIMER_STATE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	344		// RES_TEMP_PB_INTERACT_CC_BY_NAA
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	345		// RES_ERROR_LAUNCH_BROWSE_GENERIC_CODE
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	346		// RES_ERROR_CMD_BEYOND_TERMINAL_CAPAB
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	347		// RES_ERROR_CMD_TYP_NOT_UNDERSTOOD
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	348		// RES_ERROR_CMD_DATA_NOT_UNDERSTOOD
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	349		// RES_ERROR_CMD_NUMBER_NOT_KNOWN
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	350		// RES_ERROR_REQ_VALUES_MISS
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	351		// RES_ERROR_MULTIPLE_CARD_ERROR
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	352		// RES_ERROR_INTERACT_CC_SMSMO_BY_NAA
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	353		// RES_ERROR_BEARER_INDEPENDENT_PROTOCOL_ERROR
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	354		// RES_ERROR_ACCESS_TECH_ERROR
				Descriptor_Index	136		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	355		// value = 59
				}
				}
			}
			}
		...
		class_info {		// uicc/toolkit/ToolkitInterface
			...
			export_interfaces_count	1
			interfaces {
				constant_pool_index	363		// javacard/framework/Shareable
			}
			export_fields_count	0
			fields {
			}
			...
			methods {
				method_info {
					token	0
					access_flags	public abstract
					name_index	358		// processToolkit
					Descriptor_Index	359		// (S)V
				}
			}
		}
		class_info {		// uicc/toolkit/ToolkitRegistry
			...
			methods {
				method_info {
					token	0
					access_flags	public abstract
					name_index	364		// setEvent
					Descriptor_Index	359		// (S)V
				}
				method_info {
					token	1
					access_flags	public abstract
					name_index	365		// setEventList
					Descriptor_Index	366		// ([SSS)V
				}
				method_info {
					token	2
					access_flags	public abstract
					name_index	367		// clearEvent
					Descriptor_Index	359		// (S)V
				}
				method_info {
					token	3
					access_flags	public abstract
					name_index	368		// isEventSet
					Descriptor_Index	369		// (S)Z
				}
				method_info {
					token	4
					access_flags	public abstract
					name_index	370		// disableMenuEntry
					Descriptor_Index	65		// (B)V
				}
				method_info {
					token	5
					access_flags	public abstract
					name_index	371		// enableMenuEntry
					Descriptor_Index	65		// (B)V
				}
				method_info {
					token	6
					access_flags	public abstract
					name_index	372		// initMenuEntry
					Descriptor_Index	373		// ([BSSBZBS)B
				}
				method_info {
					token	7
					access_flags	public abstract
					name_index	374		// changeMenuEntry
					Descriptor_Index	375		// (B[BSSBZBS)V
				}
				method_info {
					token	8
					access_flags	public abstract
					name_index	376		// allocateTimer
					Descriptor_Index	27		// ()B
				}
				method_info {
					token	9
					access_flags	public abstract
					name_index	377		// releaseTimer
					Descriptor_Index	65		// (B)V
				}
				method_info {
					token	10
					access_flags	public abstract
					name_index	378		// requestPollInterval
					Descriptor_Index	359		// (S)V
				}
				method_info {
					token	11
					access_flags	public abstract
					name_index	379		// getPollInterval
					Descriptor_Index	1		// ()S
				}
				method_info {
					token	12
					access_flags	public abstract
					name_index	380		// allocateServiceIdentifier
					Descriptor_Index	27		// ()B
				}
				method_info {
					token	13
					access_flags	public abstract
					name_index	381		// releaseServiceIdentifier
					Descriptor_Index	65		// (B)V
				}
				method_info {
					token	14
					access_flags	public abstract
					name_index	382		// registerFileEvent
					Descriptor_Index	383		// (S[BSS[BSB)V
				}
				method_info {
					token	15
					access_flags	public abstract
					name_index	384		// deregisterFileEvent
					Descriptor_Index	383		// (S[BSS[BSB)V
				}
				method_info {
					token	16
					access_flags	public abstract
					name_index	382		// registerFileEvent
					Descriptor_Index	385		// (SLuicc/access/FileView;)V
				}
				method_info {
					token	17
					access_flags	public abstract
				...
				method_info {
					token	18
					access_flags	public abstract
					name_index	386		// setMenuEntryTextAttribute
					Descriptor_Index	36		// (B[BSS)V
				}
			}
		}
		...
		class_info {		// uicc/toolkit/TerminalProfile
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	392		// IDX_PROFILE_DOWNLOAD
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	393		// IDX_SMS_PP_DOWNLOAD
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	394		// IDX_CELL_BROADCAST_DOWNLOAD
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	395		// IDX_MENU_SELECTION
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	396		// IDX_TIMER_EXPIRATION
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	397		// IDX_CALL_CONTROLL_BY_NAA
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	398		// IDX_COMMAND_RESULT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	400		// IDX_UCS2_DISPLAY
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	401		// IDX_DISPLAY_TEXT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	402		// IDX_PROACTIVE_UICC_DISPLAY_TEXT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	403		// IDX_PROACTIVE_UICC_GET_INKEY
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	404		// IDX_PROACTIVE_UICC_GET_INPUT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	405		// IDX_PROACTIVE_UICC_MORE_TIME
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	406		// IDX_PROACTIVE_UICC_PLAY_TONE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	407		// IDX_PROACTIVE_UICC_POLL_INTERVAL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	408		// IDX_PROACTIVE_UICC_POLLING_OFF
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	409		// IDX_PROACTIVE_UICC_REFRESH
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	410		// IDX_PROACTIVE_UICC_SELECT_ITEM
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	411		// IDX_PROACTIVE_UICC_SEND_SS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	412		// IDX_PROACTIVE_UICC_SET_UP_CALL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	413		// IDX_PROACTIVE_UICC_SET_UP_MENU
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	414		// IDX_PROACTIVE_UICC_PROVIDE_LOCAL_INFORMATION_MCC_MNC_LAC_CELLID_IMEI
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	415		// IDX_PROACTIVE_UICC_PROVIDE_LOCAL_INFORMATION_NMR
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	416		// IDX_PROACTIVE_UICC_SET_UP_EVENT_LIST
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	417		// IDX_EVENT_MT_CALL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	418		// IDX_EVENT_CALL_CONNECTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	419		// IDX_EVENT_CALL_DISCONNECTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	420		// IDX_EVENT_LOCATION_STATTUS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	421		// IDX_EVENT_USER_ACTIVITY
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	422		// IDX_EVENT_IDLE_SCREEN_AVAILABLE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	423		// IDX_EVENT_CARD_READER_STATUS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	424		// IDX_EVENT_LANGUAGAE_SELECTION
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	425		// IDX_EVENT_BROWSER_TERMINATION
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	426		// IDX_EVENT_DATA_AVAILABLE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	427		// value = 42
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	428		// IDX_EVENT_CHANNEL_STATUS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	429		// IDX_EVENT_ACCESS_TECHNOLOGY_CHANGE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	430		// IDX_EVENT_DISPLAY_PARAMETER_CHANGED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	431		// IDX_EVENT_LOCAL_CONNECTION
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	432		// value = 46
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	433		// IDX_EVENT_NRETWORK_SEARCH_MODE_CHANGE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	434		// IDX_PROACTIVE_UICC_POWER_ON_CARD
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	435		// IDX_PROACTIVE_UICC_POWER_OFF_CARD
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	436		// IDX_PROACTIVE_UICC_PERFORM_CARD_APDU
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	437		// IDX_PROACTIVE_UICC_GET_READER_STATUS_STATUS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	438		// IDX_PROACTIVE_UICC_GET_READER_STATUS_IDENTIFIER
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	439		// IDX_PROACTIVE_UICC_TIMER_MANAGEMENT_START_STOP
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	440		// IDX_PROACTIVE_UICC_TIMER_MANAGEMENT_CUR_VALUE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	441		// IDX_PROACTIVE_UICC_PROVIDE_LOCAL_INFORMATION_DATE_TIME
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	442		// IDX_PROACTIVE_UICC_RUN_AT_COMMAND
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	443		// value = 61
				}
				}
			}
			field_info {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	446		// IDX_PROACTIVE_UICC_PROVIDE_LOCAL_INFORMATION_LANGUAGE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	447		// IDX_PROACTIVE_UICC_PROVIDE_LOCAL_INFORMATION_TIMING
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	448		// IDX_PROACTIVE_UICC_LANGUAGE_NOTIFICATION
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	449		// IDX_PROACTIVE_UICC_LAUNCH_BROWSER
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	450		// IDX_PROACTIVE_UICC_PROVIDE_LOCAL_INFORMATION_ACCESS_TECHNOLOGY
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	451		// IDX_SOFT_KEYS_SELECT_ITEM
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	452		// value = 72
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	453		// IDX_SOFT_KEYS_SET_UP_MENU
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	454		// IDX_PROACTIVE_UICC_OPEN_CHANNEL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	455		// value = 88
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	456		// IDX_PROACTIVE_UICC_CLOSE_CHANNEL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	457		// value = 89
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	458		// IDX_PROACTIVE_UICC_RECEIVE_DATA
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	459		// value = 90
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	460		// IDX_PROACTIVE_UICC_SEND_DATA
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	461		// value = 91
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	462		// IDX_PROACTIVE_UICC_GET_CHANNEL_STATUS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	463		// value = 92
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	464		// IDX_PROACTIVE_UICC_SERVICE_SEARCH
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	465		// value = 93
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	466		// IDX_PROACTIVE_UICC_GET_SERVICE_INFORMATION
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	467		// value = 94
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	468		// IDX_PROACTIVE_UICC_DECLARE_SERVICE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	469		// value = 95
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	471		// value = 96
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	473		// value = 97
				}
				}
			}
			field_info {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	477		// IDX_SCREEN_SIZING
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	478		// value = 111
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	479		// IDX_VARIABLE_SIZE_FONTS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	480		// value = 119
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	481		// IDX_DISPLAY_RESIZE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	482		// value = 120
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	483		// IDX_TEXT_WRAPPING
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	484		// value = 121
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	485		// IDX_TEXT_SCROLLING
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	486		// value = 122
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	487		// IDX_TEXT_ATTRIBUTE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	489		// value = 128
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	491		// value = 129
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	492		// IDX_PROACTIVE_UICC_DISPLAY_TEXT_VARIABLE_TIMEOUT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	493		// value = 136
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	494		// IDX_PROACTIVE_UICC_GET_INKEY_HELP_SUPPORTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	495		// value = 137
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	497		// value = 138
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	498		// IDX_PROACTIVE_UICC_GET_INKEY_VARIABLE_TIMEOUT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	499		// value = 139
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	500		// IDX_PROVIDE_LOCAL_INFORMATION_ESN
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	501		// value = 140
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	502		// IDX_PROVIDE_LOCAL_INFORMATION_IMEISV
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	503		// value = 142
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	504		// IDX_PROVIDE_LOCAL_INFORMATION_SEARCH_MODE_CHANGE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	505		// value = 143
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	506		// IDX_WML_BROWSER_SUPPORTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	507		// value = 160
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	508		// IDX_XHTML_BROWSER_SUPPORTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	509		// value = 161
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	510		// IDX_HTML_BROWSER_SUPPORTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	511		// value = 162
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	512		// IDX_CHTML_BROWSER_SUPPORTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	513		// value = 163
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	514		// IDX_PROVIDE_LOCAL_INFORMATION_BATTERY_STATE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	515		// value = 169
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	516		// IDX_PLAY_TONE_MELODY_THEMED_TONES
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	517		// value = 170
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	518		// IDX_MULTI_MEDIA_CALL_IN_SET_UP_CALL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	519		// value = 171
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	521		// value = 176
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	522		// IDX_GET_FRAMES_STATUS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	523		// value = 177
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	524		// IDX_EVENT_BROWSING_STATUS
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	525		// value = 192
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	526		// IDX_ALIGNMENT_LEFT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	527		// value = 216
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	528		// IDX_ALIGNMENT_CENTER
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	529		// value = 217
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	530		// IDX_ALIGNMENT_RIGHT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	531		// value = 218
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	532		// IDX_FONT_SIZE_NORMAL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	533		// value = 219
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	534		// IDX_FONT_SIZE_LARGE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	535		// value = 220
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	536		// IDX_FONT_SIZE_SMALL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	537		// value = 221
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	538		// IDX_STYLE_NORMAL
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	539		// value = 224
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	541		// value = 225
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	542		// IDX_STYLE_ITALIC
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	543		// value = 226
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	544		// IDX_STYLE_UNDERLINED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	545		// value = 227
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	546		// IDX_STYLE_STRIKETHROUGH
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	547		// value = 228
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	548		// IDX_STYLE_TEXT_FOREGROUND_COLOUR
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	549		// value = 229
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	550		// IDX_STYLE_TEXT_BACKGROUND_COLOUR
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	551		// value = 230
				}
				}
			}
			}
			...
			methods {
				method_info {
					...
					name_index	552		// check
					Descriptor_Index	553		// (B)Z
				}
				method_info {
					token	1
					access_flags	public static
					name_index	552		// check
					Descriptor_Index	554		// ([BSS)Z
				}
				method_info {
					token	2
					access_flags	public static
				...
				method_info {
					token	3
					access_flags	public static
					name_index	555		// getValue
					Descriptor_Index	556		// (SS)S
				}
				method_info {
					token	4
					access_flags	public static
				...
				method_info {
					token	0
					access_flags	public
					name_index	557		// equals
					Descriptor_Index	558		// (Ljava/lang/Object;)Z
				}
			}
		}
		class_info {		// uicc/toolkit/EnvelopeHandlerSystem
			...
			methods {
				method_info {
					token	0
					access_flags	public static
					name_index	561		// getTheHandler
					Descriptor_Index	562		// ()Luicc/toolkit/EnvelopeHandler;
				}
				method_info {
					token	0
					access_flags	public
		...
		class_info {		// uicc/toolkit/ToolkitException
			...
			supers {
				constant_pool_index	25		// java/lang/Object
				constant_pool_index	591		// java/lang/Throwable
				constant_pool_index	593		// java/lang/Exception
				constant_pool_index	595		// java/lang/RuntimeException
				constant_pool_index	597		// javacard/framework/CardRuntimeException
			}
			export_interfaces_count	0
			interfaces {
			}
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	565		// HANDLER_OVERFLOW
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	566		// HANDLER_NOT_AVAILABLE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	567		// UNAVAILABLE_ELEMENT
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	568		// MENU_ENTRY_NOT_FOUND
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	570		// EVENT_NOT_SUPPORTED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	571		// EVENT_ALREADY_REGISTERED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	572		// OUT_OF_TLV_BOUNDARIES
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	573		// TERMINAL_PROFILE_NOT_AVAILABLE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	574		// ALLOWED_LENGTH_EXCEEDED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	81		// ConstantValue
					attribute_length	2
					constantvalue_index	575		// value = 10
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	576		// NO_TIMER_AVAILABLE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	577		// INVALID_TIMER_ID
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	578		// EVENT_NOT_ALLOWED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	579		// BAD_INPUT_PARAMETER
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	580		// COMMAND_NOT_ALLOWED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	581		// NO_SERVICE_ID_AVAILABLE
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	582		// INVALID_SERVICE_ID
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	583		// TAR_NOT_DEFINED
				Descriptor_Index	80		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			methods {
				...
				method_info {
					token	1
					access_flags	public
					name_index	586		// getReason
					Descriptor_Index	1		// ()S
				}
				method_info {
					token	2
					access_flags	public
					name_index	587		// setReason
					Descriptor_Index	359		// (S)V
				}
			}
		}
		class_info {		// uicc/toolkit/ProactiveHandlerSystem
			...
			methods {
				method_info {
					...
					access_flags	public static
					name_index	561		// getTheHandler
					Descriptor_Index	598		// ()Luicc/toolkit/ProactiveHandler;
				}
				method_info {
					token	0
					access_flags	public
		...
		class_info {		// uicc/toolkit/EnvelopeResponseHandlerSystem
			...
			methods {
				method_info {
					...
					access_flags	public static
					name_index	561		// getTheHandler
					Descriptor_Index	601		// ()Luicc/toolkit/EnvelopeResponseHandler;
				}
				method_info {
					token	0
					access_flags	public
		...
		class_info {		// uicc/toolkit/ToolkitRegistrySystem
			...
			methods {
				method_info {
					token	0
					access_flags	public static
					name_index	604		// getEntry
					Descriptor_Index	605		// ()Luicc/toolkit/ToolkitRegistry;
				}
				method_info {
					token	0
					access_flags	public
		...
		class_info {		// uicc/toolkit/ProactiveResponseHandlerSystem
			...
			methods {
				method_info {
					...
					access_flags	public static
					name_index	561		// getTheHandler
					Descriptor_Index	608		// ()Luicc/toolkit/ProactiveResponseHandler;
				}
				method_info {
					token	0
					access_flags	public
